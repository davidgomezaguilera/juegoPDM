...
public class Serpiente {
    ...
    private int puntos;
    private int rangoSpeed = 10;
    private int frameActual = 0;
    private int ancho;
    private int alto;

    public Serpiente(juegoView view, Bitmap bm){
        this.view = view;
        this.bm = bm;
        ...
        //speedX = random.nextInt(rangoSpeed+1);
        //speedY = random.nextInt(rangoSpeed+1);
        speedX = VELOCIDAD_MAX;
        speedY = VELOCIDAD_MAX;
        System.out.println("SPEED X AZUL"+ speedX);
        System.out.println("SPEED Y AZUL"+ speedY);
