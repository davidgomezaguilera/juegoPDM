    ...
    public class Manta {
        ...
        private static final int VELOCIDAD_MAX= 20;
        private int puntos;
        ...
        public Manta(juegoView view, Bitmap bm){
            this.view = view;
            this.bm = bm;
            ...
            speedX = random.nextInt(VELOCIDAD_MAX)+20;
            speedY = random.nextInt(VELOCIDAD_MAX)+20;
